...
import { db, DBRecord } from './index';

export function generateSeedData(): DBRecord {
  // 1. Al Rashidiya 3, Ajman (wn5r6) Authentic Restaurants
  const ajmanRestaurants: Restaurant[] = [
    {
      id: 'rest-laffah',
    ...
    {
      id: 'rest-karachi-tarka',
      name: 'Karachi Tarka Restaurant and Cafeteria',
      slug: 'karachi-tarka-restaurant-and-cafeteria-al-rashidiya-3',
      cuisines: ['Pakistani', 'Asian', 'Biryani', 'Curry', 'Parathas'],
      rating: 4.2,
      reviewCount: 890,
      addressSummary: 'Al Rashidia 3, Ajman',
      phone: '+971 6 744 3322'
    },
    {
      id: 'rest-b4-biryani',
      name: 'B 4 Biryani Restaurant',
      slug: 'b-4-biryani-restaurant',
      cuisines: ['Indian', 'Biryani', 'Hyderabadi', 'Curry', 'Kebab'],
      rating: 4.3,
      reviewCount: 650,
      addressSummary: 'Al Rashidia / Corniche Zone, Ajman',
      phone: '+971 6 742 1199'
    },
    {
      id: 'rest-al-rukn-al-arabi',
      name: 'Al Rukn Al Arabi Restaurant',
      slug: 'al-rukn-al-arabi',
      cuisines: ['Arabic', 'Grills', 'Mandi', 'Shawarma', 'Middle Eastern'],
      rating: 4.4,
      reviewCount: 920,
      addressSummary: 'Al Rashidia 3, Ajman',
      phone: '+971 6 743 8811'
    },
    {
      id: 'rest-mandi-aljanoob',
      name: 'MANDI ALJANOOB RESTAURANT',
      slug: 'mandi-aljanoob-restaurant',
      cuisines: ['Mandi', 'Arabic', 'Yemeni', 'Grills'],
      rating: 4.4,
      reviewCount: 520,
      addressSummary: 'Al Rashidia 3, Ajman',
      phone: '+971 6 749 2244'
    },
    {
      id: 'rest-biryani-stop',
      name: 'Biryani Stop',
      slug: 'biryani-stop',
      cuisines: ['Indian', 'Biryani', 'Curry', 'North Indian', 'Chinese'],
      rating: 4.3,
      reviewCount: 1100,
      addressSummary: 'Al Rashidia 3, Ajman',
      phone: '+971 6 745 5588'
    },
    {
      id: 'rest-shawarmary',
      name: 'Shawarmary Restaurant',
      slug: 'shawarmary-restaurant',
      cuisines: ['Shawarma', 'Arabic', 'Fast Food', 'Wraps'],
      rating: 4.5,
      reviewCount: 1400,
      addressSummary: 'Al Rashidia 3, Ajman',
      phone: '+971 6 746 1133'
    },
    {
      id: 'rest-al-samak-al-arabi',
      name: 'AL SAMAK AL ARABI',
      slug: 'al-samak-al-arabi',
      cuisines: ['Seafood', 'Fish Grills', 'Arabic', 'Middle Eastern'],
      rating: 4.6,
      reviewCount: 880,
      addressSummary: 'Near Fish Market, Al Rashidia 3, Ajman',
      phone: '+971 6 747 9900'
    },
    {
      id: 'rest-italy-pizza',
      name: 'ITALY PIZZA RESTAURANT',
      slug: 'italy-pizza-restaurant',
      cuisines: ['Pizza', 'Italian', 'Pastas', 'Fast Food'],
      rating: 4.3,
      reviewCount: 750,
      addressSummary: 'Al Rashidia 3, Ajman',
      phone: '+971 6 744 7722'
    },
    {
      id: 'rest-healthy-club',
      name: 'Healthy Club Restaurant',
      slug: 'healthy-club-restaurant',
      cuisines: ['Healthy', 'Bowls', 'Salads', 'Diet Meals', 'Wraps'],
      rating: 4.4,
      reviewCount: 1050,
      addressSummary: 'Al Rashidia 3, Ajman',
      phone: '+971 6 741 0099'
    }
  ];

  // 2. Downtown Dubai (thk0w) Authentic Restaurants
  const dubaiRestaurants: Restaurant[] = [
    {
      id: 'rest-zuma-dubai',
      name: 'Zuma Dubai',
      slug: 'zuma-dubai',
  ...
  const marinaRestaurants: Restaurant[] = [
    {
  ...
  const menuItems: MenuItem[] = [
    ...
    // Karachi Tarka Restaurant & Cafeteria (Noon Food + Talabat)
    { id: 'item-karachi-tarka-biryani', restaurantId: 'rest-karachi-tarka', name: 'Karachi Special Chicken Biryani with Raita', description: 'Authentic Karachi-style spicy aromatic basmati rice with marinated chicken, potatoes, and homemade cucumber mint raita.', basePriceAed: 20, category: 'Biryani', isPopular: true },
    { id: 'item-karachi-tarka-karahi', restaurantId: 'rest-karachi-tarka', name: 'Chicken Shinwari Karahi (Half)', description: 'Fresh chicken cooked with fresh tomatoes, green chilies, black pepper and ginger in pure ghee, served with 2 tandoori rotis.', basePriceAed: 35, category: 'Karahi & Handi', isPopular: true },
    { id: 'item-karachi-tarka-paratha-roll', restaurantId: 'rest-karachi-tarka', name: 'Chicken Bihari Boti Paratha Roll', description: 'Tender marinated smoky chicken bihari boti with spicy green chutney and onions in crispy Puri paratha.', basePriceAed: 14, category: 'Paratha Rolls', isPopular: true },

    // B 4 Biryani Restaurant (Talabat)
    { id: 'item-b4-hyderabadi-biryani', restaurantId: 'rest-b4-biryani', name: 'B 4 Special Mutton Dum Biryani', description: 'Rich authentic Hyderabadi kacchi dum mutton biryani cooked on slow charcoal fire with mirchi ka salan and raita.', basePriceAed: 28, category: 'Dum Biryani', isPopular: true },
    { id: 'item-b4-chicken-65', restaurantId: 'rest-b4-biryani', name: 'Spicy Chicken 65 (Dry)', description: 'Crispy fried boneless chicken tossed with South Indian spices, curry leaves and green chilies.', basePriceAed: 22, category: 'Starters', isPopular: true },

    // Al Rukn Al Arabi Restaurant (Talabat)
    { id: 'item-al-rukn-mix-grill', restaurantId: 'rest-al-rukn-al-arabi', name: 'Al Rukn Charcoal Mixed Grill Platter', description: 'Fresh charcoal grilled shish tawook, lamb tikka, kofta kebab, roasted tomatoes, garlic toum, spicy bread.', basePriceAed: 45, category: 'Arabic Grills', isPopular: true },
    { id: 'item-al-rukn-half-chicken-mandi', restaurantId: 'rest-al-rukn-al-arabi', name: 'Charcoal Smoked Half Chicken Mandi', description: 'Tender charcoal smoked chicken with spiced mandi basmati rice, hot daqoos tomato sauce and soup.', basePriceAed: 26, category: 'Mandi Rice', isPopular: true },

    // Mandi Aljanoob Restaurant (Talabat)
    { id: 'item-mandi-aljanoob-meat', restaurantId: 'rest-mandi-aljanoob', name: 'Mandi Meat Fresh Naimi Plate', description: 'Slow cooked tender fresh lamb with aromatic Yemeni spices, basmati rice, daqoos and clear bone broth soup.', basePriceAed: 65, category: 'Mandi', isPopular: true },

    // Biryani Stop (Talabat)
    { id: 'item-biryani-stop-butter-chicken-biryani', restaurantId: 'rest-biryani-stop', name: 'Butter Chicken Fusion Biryani Bowl', description: 'Creamy rich butter chicken layered with spiced fragrant saffron basmati rice.', basePriceAed: 30, category: 'Biryani Bowls', isPopular: true },

    // Shawarmary (Talabat & Deliveroo)
    { id: 'item-shawarmary-super-plate', restaurantId: 'rest-shawarmary', name: 'Shawarmary Duo Combo (Chicken & Beef)', description: 'Two large toasted saj shawarmas cut into bite sizes, fries, garlic toum, spicy tahina, pickles.', basePriceAed: 32, category: 'Combos', isPopular: true },

    // AL SAMAK AL ARABI (Talabat)
    { id: 'item-samak-arabi-sea-bream', restaurantId: 'rest-al-samak-al-arabi', name: 'Fresh Sea Bream (Supreme) Charcoal Grilled', description: 'Whole fresh sea bream fish marinated in traditional Arabic spices, served with Sayadieh brown spiced rice.', basePriceAed: 55, category: 'Fresh Seafood', isPopular: true },

    // ITALY PIZZA RESTAURANT (Talabat & Deliveroo)
    { id: 'item-italy-pizza-quattro', restaurantId: 'rest-italy-pizza', name: 'Quattro Formaggi Pizza (Large)', description: 'Italian mozzarella, gorgonzola, parmesan, and provolone on thin crispy stone-baked crust.', basePriceAed: 45, category: 'Italian Pizza', isPopular: true },

    // Healthy Club Restaurant (Talabat & Deliveroo)
    { id: 'item-healthy-club-grilled-salmon', restaurantId: 'rest-healthy-club', name: 'Grilled Atlantic Salmon with Quinoa & Steamed Veggies', description: 'Fresh pan-seared salmon fillet (180g), lemon herb quinoa, steamed asparagus, and light garlic sauce (480 kcal).', basePriceAed: 48, category: 'Healthy Mains', isPopular: true },
  ...
  // Specific platform availability per restaurant
  const RESTAURANT_PLATFORMS: Record<string, PlatformId[]> = {
    'rest-karachi-tarka': ['noon', 'talabat'],
    'rest-b4-biryani': ['talabat'],
    'rest-al-rukn-al-arabi': ['talabat'],
    'rest-mandi-aljanoob': ['talabat'],
    'rest-biryani-stop': ['talabat'],
    'rest-shawarmary': ['talabat', 'deliveroo'],
    'rest-al-samak-al-arabi': ['talabat'],
    'rest-italy-pizza': ['talabat', 'deliveroo'],
    'rest-healthy-club': ['talabat', 'deliveroo']
  };

  // Multi-platform price variations
  const platformFees: Record<string, Record<PlatformId, DeliveryFee>> = {};
  const platformItemPrices: Record<string, Record<PlatformId, { basePriceAed: number; discountPercent?: number; isAvailable: boolean }>> = {};
  const offers: Record<string, OfferBadge[]> = {};
  ...
  menuItems.forEach((item) => {
    const supported = RESTAURANT_PLATFORMS[item.restaurantId] || ['talabat', 'noon', 'careem', 'deliveroo', 'keeta', 'smiles'];

    platformItemPrices[item.id] = {
      talabat: {
        basePriceAed: item.basePriceAed,
        discountPercent: item.isPopular ? 10 : 0,
        isAvailable: supported.includes('talabat')
      },
      noon: {
        basePriceAed: Math.max(8, item.basePriceAed - 1),
        discountPercent: 15,
        isAvailable: supported.includes('noon')
      },
      careem: {
        basePriceAed: item.basePriceAed + 1,
        discountPercent: 0,
        isAvailable: supported.includes('careem')
      },
      deliveroo: {
        basePriceAed: item.basePriceAed,
        discountPercent: 0,
        isAvailable: supported.includes('deliveroo')
      },
      keeta: {
        basePriceAed: Math.max(8, item.basePriceAed - 2),
        discountPercent: 25,
        isAvailable: supported.includes('keeta')
      },
      smiles: {
        basePriceAed: item.basePriceAed,
        discountPercent: 10,
        isAvailable: supported.includes('smiles')
      }
    };
  });

  const platformGlobalOffers: Record<PlatformId, OfferBadge[]> = {
    talabat: [
  ...
  const gridCells: Record<string, LocationCell> = {};
  const gridCellRestaurants: Record<string, string[]> = {};
