...
async function testLiveRefresh() {
  ...
  const refreshRes = await crawlerService.refreshCell({
    geohash: 'wn5r6',
    lat: 25.3995,
    lng: 55.4455
  });
