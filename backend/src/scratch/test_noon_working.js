async function testNoonWorking() {
  const headers = {
  ...
  // Test 1: Geo with { location: { lat, lng } }
  try {
  ...
  // Test 2: Catalog GET for Downtown Dubai
  try {
    const catUrl = 'https://food.noon.com/_svc/mp-food-api-catalog/api?lat=25.1972&lng=55.2744';
  ...
  try {
    const searchUrl = 'https://food.noon.com/_svc/mp-food-api-catalog/api/search?q=shawarma&lat=25.1972&lng=55.2744';
    ...
    console.log('Search snippet:', text.slice(0, 500));
  } catch (e) {
